...
export default function KanbasNavigation() {
  return (
    ...
    <div id="wd-kanbas-navigation" className="list-group rounded-0">
     ...
     <a id="wd-neu-link" target="_blank" rel="noreferrer" href="https://www.northeastern.edu/"  className="list-group-item bg-black border-0">
        <img src="/images/favicon.png" alt="img not found" width="75px" /></a>
      ...
      <a id="wd-course-link" href="#/Kanbas/Courses"
        ...
        <a id="wd-labs-link" href="#/Kanbas/Labs" className="list-group-item text-white
                   bg-black text-center border-0">
